...
Note that $a_n$ and $b_n$ remain at the same value as long as no external forces are applied to the string (explanation: $a_n$ and $b_n$ are not function of $t$ in $(2)$). This property lead to the fact that we don't need to do any computation 
